...
use AmeyemQuiz\Http\Requests\StoreQuestionsRequest;
use AmeyemQuiz\Http\Requests\UpdateQuestionsRequest;
...
class QuestionsController extends Controller
{
    ...
    {
        $relations = [
            'topics' => \AmeyemQuiz\Topic::get()->pluck('title', 'id')->prepend('Please select', ''),
        ];
     ...
     *
     * @param  \AmeyemQuiz\Http\Requests\StoreQuestionsRequest  $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \AmeyemQuiz\Http\Requests\UpdateQuestionsRequest  $request
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
