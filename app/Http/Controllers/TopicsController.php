...
use AmeyemQuiz\Http\Requests\StoreTopicsRequest;
use AmeyemQuiz\Http\Requests\UpdateTopicsRequest;
...
class TopicsController extends Controller
{
     ...
     *
     * @param  \AmeyemQuiz\Http\Requests\StoreTopicsRequest  $request
     * @return \Illuminate\Http\Response
     */
     ...
     *
     * @param  \AmeyemQuiz\Http\Requests\UpdateTopicsRequest  $request
     * @param  int  $id
     * @return \Illuminate\Http\Response
     */
